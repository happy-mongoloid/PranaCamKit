...
#ifndef PRANACAMKIT_SWIFT_H
#define PRANACAMKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PranaCamKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11PranaCamKit16PVCaptureManager")
...
@interface PVCaptureManager (SWIFT_EXTENSION(PranaCamKit)) <AVCaptureFileOutputRecordingDelegate>
